...
export default function HeroSection() {
  return (
    <section id="hero" className="relative bg-gradient-to-br from-white via-blue-50/30 to-orange-50/30 h-[calc(100vh-120px)] flex items-center justify-center overflow-hidden">
      {/* Background Pattern */}
